#!/bin/bash
packagesString="wget build-essential cmake djmount gimp htop i3-wm i3-lock bash- completion pass python3-dev ranger secure-delete tmux vim vim-gtk zathura python3-tk"
